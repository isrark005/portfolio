...
export function MyProjectsSection() {
    ...
    return (
        <section className="my-projects z-[150]  my-20 ">
          <div className="heading text-6xl text-center z-[150]">
            <h2>My Projects</h2>
          </div>
          <div className="projects  mt-20 flex flex-wrap justify-between container-custom z-[150]">
            <div className="project z-[150]  w-[643px] bg-black border-white rounded-2xl border-4 p-10">
              <div className="project-upper flex">
                <div className="content w-8/12">
                  ...
                  <p className="my-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
                </div>
